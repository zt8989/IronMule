...
public:
	...
	CFriend*	SearchFriend(const uchar* achUserHash, const CAddress& IP, uint16 nPort) const;
#else // NEO: IP6 END
...
#ifdef USE_IP_6 // NEO: IP6 - [IPv6]
	bool		AddFriend(const uchar* abyUserhash, uint32 dwLastSeen, const CAddress& LastUsedIP, uint16 nLastUsedPort, 
