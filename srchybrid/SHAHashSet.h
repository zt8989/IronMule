...
public:
	...
	bool	AddSigningIP(const CAddress& IP, bool bTestOnly);
#else // NEO: IP6 END
	...
	CAICHHash				m_Hash;
#ifdef USE_IP_6 // NEO: IP6 - [IPv6]
	CArray<CAddress, CAddress>	m_adwIpsSigning;
#else // NEO: IP6 END
...
#ifdef USE_IP_6 // NEO: IP6 - [IPv6]
	void			UntrustedHashReceived(const CAICHHash& Hash, const CAddress& FromIP);
#else // NEO: IP6 END
