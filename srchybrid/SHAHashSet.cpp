...
bool CAICHUntrustedHash::AddSigningIP(const CAddress& dwIP, bool bTestOnly){
#else // NEO: IP6 END
...
#ifdef USE_IP_6 // NEO: IP6 - [IPv6]
void CAICHRecoveryHashSet::UntrustedHashReceived(const CAICHHash& Hash, const CAddress& dwFromIP){
#else // NEO: IP6 END
